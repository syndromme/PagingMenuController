...
extension PagingMenuController {
    ...
    @IBAction internal func handleTapGesture(_ recognizer: UITapGestureRecognizer) {
    ...
    @IBAction internal func handleSwipeGesture(_ recognizer: UISwipeGestureRecognizer) {
